...
const ResumePage = () => {
    ...
    return (
        <div className="space-y-6 md:space-y-8">
            {/* Header */}
            <div className="relative bg-gradient-to-r from-dark-200 via-dark-250 to-dark-300 rounded-xl p-6 md:p-8 border border-dark-300 overflow-hidden">
                {/* Background pattern */}
                ...
                <div className="relative z-10">
                    <div className="flex flex-col sm:flex-row items-start justify-between gap-4 mb-4">
                        <div className="flex items-start sm:items-center gap-3">
                            <div className="w-10 h-10 md:w-12 md:h-12 bg-primary-200/20 rounded-lg flex items-center justify-center flex-shrink-0">
                            ...
                            <div>
                                <h1 className="text-2xl md:text-3xl font-bold text-primary-100 mb-1">
                                    Resume Feedback
                                </h1>
                        ...
                        {resumeCredits !== null && (
                            <div className="flex items-center gap-2 bg-dark-100/30 rounded-lg px-3 py-2 border border-dark-400/50 w-full sm:w-auto justify-between sm:justify-start">
                                <div className="w-5 h-5 md:w-6 md:h-6 bg-primary-200/20 rounded-full flex items-center justify-center flex-shrink-0">
                                    <svg className="w-3 h-3 md:w-3.5 md:h-3.5 text-primary-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-dark-200 border border-dark-300 rounded-lg p-4 md:p-6">
                <h2 className="text-lg md:text-xl font-semibold text-primary-100 mb-4">
                    Upload Your Resume
                </h2>
                <ResumeUpload
                ...
                {uploadedFile && (
                    <div className="mt-6 flex flex-col sm:flex-row gap-3 md:gap-4">
                        <Button
                            ...
                            className="bg-primary-200 hover:bg-primary-100 text-dark-100 w-full sm:w-auto"
                        >
                            {isAnalyzing ? (
                                <>

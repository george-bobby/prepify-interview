    ...
    return (
        <div className="min-h-screen relative overflow-hidden bg-black -mx-8 w-[calc(100%+4rem)]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                            ...
                            <div className="text-center group">
                                <div className="mb-6 flex justify-center">
                                    <div className="w-24 h-24 bg-gradient-to-br from-orange-500 to-orange-600 rounded-full flex items-center justify-center shadow-lg shadow-orange-600/30 transform group-hover:scale-110 transition-transform duration-300">
            ...
            {/* Step 2 */}
                            <div className="text-center group">
                                <div className="mb-6 flex justify-center">
                                    <div className="w-24 h-24 bg-gradient-to-br from-[#c0fe72] to-[#b8ec68] rounded-full flex items-center justify-center shadow-lg shadow-[#c0fe72]/30 transform group-hover:scale-110 transition-transform duration-300">

    ...
    return (
        <div className="flex flex-col gap-4 md:gap-5">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
                ...
                <div className="relative bg-gradient-to-br from-gray-900 to-black border-2 border-[#c0fe72]/30 rounded-3xl p-4 md:p-6 shadow-2xl shadow-[#c0fe72]/20 overflow-hidden">
                    ...
                    <div className="relative z-10 flex flex-col items-center text-center gap-3">
                        ...
                        <div className="relative">
                            <div className={cn(
                                "w-20 h-20 md:w-24 md:h-24 rounded-full bg-gradient-to-br from-[#c0fe72] to-[#9cd052] p-1 shadow-2xl",
                        ...
                        <div className="grid grid-cols-2 gap-2 w-full mt-2">
                            <div className="bg-white/5 border border-[#c0fe72]/20 rounded-xl p-2">
                                <div className="text-xl mb-1">🧠</div>
                                <div className="text-xs text-gray-400">AI-Powered</div>
                            </div>
                            <div className="bg-white/5 border border-[#9cd052]/20 rounded-xl p-2">
                                <div className="text-xl mb-1">🎯</div>
                ...
                <div className="relative bg-gradient-to-br from-gray-900 to-black border-2 border-[#9cd052]/30 rounded-3xl p-4 md:p-6 shadow-2xl shadow-[#9cd052]/20 overflow-hidden">
                    
                    <div className="relative z-10 flex flex-col items-center text-center gap-3">
                        {/* User Avatar */}
                        <div className="relative">
                            {typeof window !== 'undefined' && window.localStorage.getItem('profileImage') ? (
                                <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-gradient-to-br from-[#9cd052] to-[#7cb342] p-1 shadow-2xl">
                                    <Image
                                ...
                                <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-gradient-to-br from-[#9cd052] to-[#7cb342] flex items-center justify-center text-3xl md:text-4xl font-bold text-black shadow-2xl">
            ...
            <div className="relative bg-gradient-to-br from-gray-900 to-black border-2 border-[#c0fe72]/30 rounded-3xl p-4 md:p-6 shadow-2xl shadow-[#c0fe72]/20 min-h-[120px] flex items-center justify-center">
            ...
            <div className="flex flex-col items-center gap-4">
                {interviewStatus === InterviewStatus.INACTIVE ? (
                    <button
                        className="relative bg-gradient-to-r from-[#c0fe72] to-[#9cd052] text-black font-bold rounded-2xl px-8 py-4 text-lg shadow-2xl shadow-[#c0fe72]/30 disabled:opacity-50 disabled:cursor-not-allowed"
                    ...
                    <div className="w-full max-w-2xl flex flex-col gap-4">
                        ...
                        <div className="flex flex-wrap gap-2 justify-center">
                            <button
                                className={cn(
                                    "px-4 py-2 rounded-xl font-semibold flex items-center gap-2 text-sm",
                                    !isTextMode 
                        ...
                        {isTextMode ? (
                            <div className="flex flex-col sm:flex-row gap-2">
                                <input
                                    ...
                                    className="flex-1 px-4 py-3 bg-white/5 border-2 border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-[#c0fe72] transition-colors text-base"
                                    disabled={interviewStatus === InterviewStatus.PROCESSING}
                                />
                                <button
                                    className="bg-gradient-to-r from-[#c0fe72] to-[#9cd052] text-black font-bold rounded-xl px-6 py-3 shadow-lg shadow-[#c0fe72]/30 disabled:opacity-50 disabled:cursor-not-allowed"
                            ...
                            <button
                                className={cn(
                                    "bg-gradient-to-r from-[#c0fe72] to-[#9cd052] text-black font-bold rounded-xl px-8 py-4 shadow-lg shadow-[#c0fe72]/30 disabled:opacity-50 disabled:cursor-not-allowed text-base",
                        ...
                        <button
                            className="bg-white/5 border-2 border-red-500/50 text-red-400 font-bold rounded-xl px-6 py-3"
                    ...
                    <button
                        className="bg-gradient-to-r from-[#c0fe72] to-[#9cd052] text-black font-bold rounded-2xl px-8 py-4 text-lg shadow-2xl shadow-[#c0fe72]/30"
